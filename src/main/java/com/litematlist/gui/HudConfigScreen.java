...
public class HudConfigScreen extends GuiBase {
    ...
    public void extractRenderState(GuiGraphicsExtractor gfx, int mouseX, int mouseY, float partialTicks) {
        ...
        if (page == 0) {
            ...
            drawToggleLabel(ctx, boxBtnLabel, boxBtnX, boxBtnY, boxBtnW, MaterialDetailScreen.persistedHudShowBox);
            drawToggleLabel(ctx, groupBtnLabel, groupBtnX, groupBtnY, groupBtnW, MaterialDetailScreen.persistedHudShowGroup);
            drawToggleLabel(ctx, showHudBtnLabel, showHudBtnX, showHudBtnY, showHudBtnW, MaterialDetailScreen.persistedHudVisible);
        }
