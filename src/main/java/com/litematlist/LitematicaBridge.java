...
public class LitematicaBridge {
    ...
    public static List<SchematicInfo> getLoadedSchematics() {
        ...
        try {
            ...
            Path filePath = schematicFile.toPath();
            if (filePath != null) {
    ...
    public static LayerFilter computeRenderLayerFilter(Path filePath) {
        ...
        try {
            ...
            for (SchematicPlacement placement : DataManager.getSchematicPlacementManager().getAllSchematicsPlacements()) {
                java.io.File placementFileRaw = placement.getSchematicFile();
                if (placementFileRaw == null) {
                    continue;
                }
                Path placementFile = placementFileRaw.toPath();
                if (placementFile.toAbsolutePath().normalize().equals(target) == false) {
                    continue;
                }
